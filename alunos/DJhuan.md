...
- **GitHub:** @DJhuan
- **Curso e periodo:** Ciência da Computação, 8º período
- **Linguagem que voce domina melhor:** JavaScript
- **Ja usou Linux no dia a dia?** sim
- **Ja usou Docker?** sim
- **O que voce espera desta disciplina:** espero compreender melhor como implementar uma esteira de DevOps no meu trabalho, seja ele acadêmico ou empresarial. 
...
Frequência de implantação, uma vez que quando uma subida era realizada, muitas alterações surgiam e consequentemente a quantidade de bugs também, o que era um problema para conciliar com as novas features. 
